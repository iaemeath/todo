...
用户的语音指令是："${text}"`
  ...
  // Use regex to robustly extract the JSON object, ignoring any leading/trailing markdown or conversational text
  ...
  try {
    const parsed = JSON.parse(jsonString) as ParsedTask
